...
public class ProductSpecificationAdapter extends RecyclerView.Adapter<ProductSpecificationAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ProductSpecificationAdapter.ViewHolder holder, int position) {
        ...
        switch ((productSpecificationModelList.get(position).getType())) {
            case ProductSpecificationModel.SPECIFICATION_TITLE:
                ...
                break;
            case ProductSpecificationModel.SPECIFICATION_BODY:
                String model = productSpecificationModelList.get(position).getModel();
                String year = productSpecificationModelList.get(position).getYear();
                holder.setCompatibility(model, year);
                break;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private void setCompatibility(String model, String year) {
            modelName = itemView.findViewById(R.id.carModel);
            modelYear = itemView.findViewById(R.id.modelYear);
            modelName.setText(model);
            modelYear.setText(year);
        }
    }
}
